...
Filtrar posts por título – permite buscar posts que contenham uma palavra-chave.
Rota: /api/posts/filtrar/?q=palavra (GET)
Administração via Django Admin – adicionar, editar ou deletar posts e comentários.
Rota: /admin/

💡 Funcionalidades extras que você poderia adicionar depois:
...
data_criacao (DateTimeField) → data/hora de criação do post.
Comentario
post (ForeignKey para Post) → post relacionado ao comentário.
